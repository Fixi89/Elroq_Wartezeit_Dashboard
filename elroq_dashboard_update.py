...
def _migrate_stale_predictions(log, delivered, open_by_id, now_ts):
    """
    Einmalige Migration fuer Log-Eintraege, die mit einer AELTEREN Version der
    Prognose-Methode berechnet wurden (z.B. vor dem Laender-Fix oder vor den
    80%/95%-Konfidenzintervallen). Solche Alteintraege sind am fehlenden Feld
    "PredictedP10Days" erkennbar — das gibt es erst seit der aktuellen Version.
